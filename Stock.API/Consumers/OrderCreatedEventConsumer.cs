    ...
    public class OrderCreatedEventConsumer : IConsumer<OrderCreatedEvent>
    {
        ...
        public async Task Consume(ConsumeContext<OrderCreatedEvent> context)
        {
            ...
            if (stockResult.All(x => x.Equals(true))) //Stock listesindeki ürünlerin hepsinin stoğu var ise == true
            {
                ...
                var sendEndpoint = await _sendEndpointProvider.GetSendEndpoint(new Uri($"queue:{RabbitMQSettingsConst.StockReservedEventQueueName}")); //Send ile bir kuyruğa gönderdik. Publish yapsaydık buna gerek yoktu!
            ...
            else
            {
                ...
                _logger.LogInformation($"Not enough stock reserved for Buyer Id: {context.Message.BuyerId}");
            }
        }
    }
}
